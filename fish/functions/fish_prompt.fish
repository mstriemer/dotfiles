...
function fish_prompt
  ...
  echo -s (set_color $fish_color_user) "$USER" $normal @ (set_color $fish_color_host) "$__fish_prompt_hostname" $normal (__fish_vcs_prompt) $normal
  echo -ns (set_color green) (prompt_pwd) (set_color normal) $prompt_status "> "
end
